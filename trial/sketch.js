function setup() {
 ...
 // var normText = createFont("futura", 12);
  ...
  var bars = {
    x: [0, 180, random(50, 350), random(50, 350), random(50, 350), random(50, 350)],
    y: [0, 280, random(0, 100), random(-50, 50), random(-50, 0), random(-100, -30)],
    type: [0, 0, 0, 0, 0],
    used: [0, 0, 0, 0, 0],
    Rmax: [],
    veloc: []
...
var restart = function() {
  ...
  charY = 72;
  bars = {
    x: [random(50, 350), 180, random(50, 350), random(50, 350), random(50, 350)],
    y: [random(300, 350), 250, random(100, 150), random(0, 100), random(-50, 0)],
    type: [],
    used: [],
    Rmax: [],
    veloc: []
...
var draw = function() {
  ...
  if (!state) {
    ...
    stroke(0, 0, 0);
    makeButton(180, 110, "START", start);
    feetX = charX + -15;
    feetY = charY + 40;
    stroke(0, 0, 0);
    fill(72, 255, 0);
  ...
  rotate(90);
  textSize(8);
  text("Doodle Jump is Property of Lima Sky, Code is by Nordituck", 180, -3);
  resetMatrix();
  //￪ leave this here ⬆
